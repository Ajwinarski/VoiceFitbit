...
class VoiceActivityDetector():
    ...
    #print window[0], speech_time_end
        ...
        for x in speech_time:
            speech_period = x["speech_end"]-x["speech_begin"]
            total_speech_time = total_speech_time+speech_period
        speech_label={}
        speech_label['Total_speechTime'] = total_speech_time
        speech_time.append(speech_label)
        return speech_time, total_speech_time
