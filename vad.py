...
class VoiceActivityDetector():
    ...
    def __init__(self, stream, rate):
        self.data = stream                      # Real-time audio stream
        self.rate = rate                        # 44100 Hz
        self.sample_window = 0.03125            # 20 ms
        self.sample_overlap = 0.01              # 10 ms
        self.speech_window = 0.5                # half a second
        self.speech_energy_threshold = 0.6      # 60% of energy in voice band
        self.speech_start_band = 300            # lower frequency band
        self.speech_end_band = 3000             # upper frequency band
        # len(data) = freq * duration of audio file
